...
public class DatabaseConfiguration
{
    ...
    {
        this.attributes.put("databaseName",
                            path);
        return this;
    }
    ...
    {
        this.attributes.put("useUnicode",
                            "true");
        return this;
    }
    ...
    {
        this.attributes.put("characterEncoding",
                            encoding);
        return this;
    }
    ...
    {
        this.attributes.put("autoReconnect",
                            "true");
        return this;
    }
    ...
    {
        this.attributes.put("dataEncryption",
                            "true");
        this.attributes.put("bootPassword",
                            bootPassword);
        return this;
    }
    ...
    {
        this.attributes.put("user",
                            user);
        this.attributes.put("password",
                            password);
        return this;
    }
