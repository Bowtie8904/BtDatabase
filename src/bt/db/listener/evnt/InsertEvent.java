...
/**
 * Fired by the {@link DatabaseAccess} implementation when an INSERT trigger is detected.
 * 
 * @author &#8904
 */
public class InsertEvent extends DatabaseChangeEvent
{
    /**
     ...
     */
    public InsertEvent(DatabaseAccess sourceDB, String table, String idFieldName, long id, String... data)
    {
